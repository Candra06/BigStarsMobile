                ...
                Column(
                  children: [
                    ...
                    Container(
                        ...
                        child: FutureBuilder(
                          future: Provider.of<AuthProvider>(context, listen: false).getDashboard(),
                          builder: (context, snapshot) {
                            ...
                            return Consumer<AuthProvider>(
                              builder: (context, data, child) {
                                // setState(() {
                                notifUnread = data.dashboardModel.notifUnread;
                                // });
                                          ...
                                          Expanded(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  data.dashboardModel.siswa.toString(),
                                          ...
                                          Expanded(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  data.dashboardModel.kelas.toString(),
                                                  style: TextStyle(fontWeight: FontWeight.w800, color: Config.textWhite, fontSize: 24),
                                                ),
                                              ],
                                            ),
                                          ...
                                          Expanded(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  data.dashboardModel.guru.toString(),
                                                  style: TextStyle(fontWeight: FontWeight.w800, color: Config.textWhite, fontSize: 24),
                                                ),
                                              ],
                                            ),
                                          ...
                                          Expanded(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  data.dashboardModel.kelasAktif.toString(),
                                                  style: TextStyle(fontWeight: FontWeight.w800, color: Config.textWhite, fontSize: 24),
                                                ),
                                              ],
                                            ),
                                      ...
                                      if (dashboardModel.kelasToday.length == 0) ...{
                                        ...
                                        Container(
                                          ...
                                          child: ListView.builder(
                                              shrinkWrap: true,
                                              physics: NeverScrollableScrollPhysics(),
                                              itemCount: data.dashboardModel.kelasToday.length,
                                              itemBuilder: (BuildContext cotext, int i) {
                                                if (dashboardModel.kelasToday.isEmpty) {
                                                  ...
                                                  return Container(
                                                    margin: i == (data.dashboardModel.kelasToday.length - 1) ? EdgeInsets.only(bottom: 30) : EdgeInsets.only(bottom: 0),
                                                    child: ItemKelasToday(
                                                      data: data.dashboardModel.kelasToday[i],
                                                    ),
                                                  );
                                                }
                                              }),
