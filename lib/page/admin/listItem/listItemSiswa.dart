...
class _ItemListSiswaState extends State<ItemListSiswa> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.pushNamed(context, Routes.DETAIL_SISWA, arguments: widget.data['id']);
      },
      child: Container(
              ...
              children: [
                ...
                Row(
                  children: [
                    IconButton(
                        onPressed: () {
                          Navigator.pushNamed(context, Routes.EDIT_SISWA, arguments: widget.data['id'].toString());
                        },
                        icon: Icon(
                          Icons.edit,
